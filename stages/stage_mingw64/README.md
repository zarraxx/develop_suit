...
```text
stages/stage_mingw64/build/out/x86_64
stages/stage_mingw64/build/out/aarch64
stages/stage_mingw64/build/out/riscv64
stages/stage_mingw64/build/out/loongarch64
```
...
```bash
./stages/stage_mingw64/build.sh --arch=x86_64 --clean --pull --jobs=4
```
...
```bash
./stages/stage_mingw64/image.sh --arch=x86_64
```
...
executables under `stages/stage_mingw64/build/smoke/<arch>`. It does not run the
Windows binaries.
