...
case "$TARGET_KIND" in
  ...
  mingw)
    ...
    CMAKE_STANDARD_LIBRARY_ARGS=(
      "-DCMAKE_CXX_STANDARD_LIBRARIES=${SDK_PREFIX}/lib/${TARGET_TRIPLE}/libc++.dll.a ${SDK_PREFIX}/lib/${TARGET_TRIPLE}/libc++abi.a ${SDK_PREFIX}/lib/${TARGET_TRIPLE}/libunwind.dll.a"
    )
    CMAKE_RPATH_ARGS=()
    ;;
  *)
