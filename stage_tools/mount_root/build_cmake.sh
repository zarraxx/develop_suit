...
HOST_CC="${TOOLCHAIN_ROOT}/bin/${HOST_TRIPLE}-clang"
HOST_CXX="${TOOLCHAIN_ROOT}/bin/${HOST_TRIPLE}-clang++"
...
TARGET_CC="${TOOLCHAIN_ROOT}/bin/${TARGET_TRIPLE}-clang"
TARGET_CXX="${TOOLCHAIN_ROOT}/bin/${TARGET_TRIPLE}-clang++"
